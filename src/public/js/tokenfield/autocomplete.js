 ...
 */
var autocomplete = module.exports = function (caret) {
...
autocomplete.prototype.$markup = function () {
...
autocomplete.prototype.updateContents = function (event, local) {
  var that = this,
  ...
  function updateState() {
    ...
    if (that.items.length) {
      ...
      $.each(that.items, function () {
        $e.append($('<span>').addClass("line").addClass("style-" + this.type).html('<span class="prefix">' + misc.escapeText(prefix) +'</span><span>'+ misc.escapeText(this.label.substring(prefix.length)) +'</span>'));
      });
      $e.show();
...
autocomplete.prototype.onComplete = function (event, local) {
